    ...
    <section className="bg-gray-200 py-10">
      <div className="max-w-4xl mx-auto bg-white border shadow-md rounded-2xl p-6 text-black">
        ...
        <ul className="space-y-2 list-disc list-inside pl-2">
          ...
          <li>
            <span className="font-semibold">Frontend:</span> React, HTML, CSS,
            Tailwind CSS, Bootstrap, Responsive Design
          </li>

          <li>
            <span className="font-semibold">Backend:</span> Node.js, Express.js,
            REST APIs, API Integration, Authentication
          </li>

          <li>
            <span className="font-semibold">Testing:</span> Vitest, React
            Testing Library, GitHub Actions, Unit Testing
          </li>
